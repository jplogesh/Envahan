...
const Ongoing = ({ navigation }) => {
  ...
  const clickHandler = () => {
    navigation.navigate("Trip Tracking");
  };
  const clickHandler1 = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titcontainer}>
        ...
        {/* <TouchableOpacity> */}
        <Text style={styles.tit2}>Ongoing</Text>
        {/* </TouchableOpacity> */}
        <TouchableOpacity>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <TouchableOpacity onPress={clickHandler}>
          <MyBid bidbtn1="At Pickup" bidid={564565} bidtime="05 Nov 3:10 PM" />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={clickHandler}>
          <MyBid bidbtn1="Unloading" bidid={564565} bidtime="05 Nov 6:10 PM" />
        </TouchableOpacity>
        <TouchableOpacity onPress={clickHandler}>
          <MyBid
            bidbtn1="Loading"
