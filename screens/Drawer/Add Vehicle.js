  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.titcontainer}>
        <TouchableOpacity>
          <Text style={styles.tit1}>Add Vehicle</Text>
        </TouchableOpacity>
      </View>
      <ScrollView>
        <ScrollView showsVerticalScrollIndicator={false}>
          <Text style={styles.txt}> Select Model :</Text>
          <TextInput
            style={styles.txtip}
            placeholder="Options >"
            keyboardType="default"
          />
          <Text style={styles.txt}>Vehicle Name :</Text>
          ...
          <TextInput
            style={styles.txtip}
            keyboardType="default"
            placeholder="   Available Driver List >"
          />

          <Text style={styles.txt}>Availablity :</Text>
          <TextInput
            style={styles.txtip}
            keyboardType="default"
            placeholder="Options >"
          ...
          >
            <View style={styles.centeredView}>
              <View style={styles.modalView}>
                ...
                >
                  <Text style={styles.textStyle}>Add Another Product</Text>
                </TouchableOpacity> */}
                <TouchableOpacity
